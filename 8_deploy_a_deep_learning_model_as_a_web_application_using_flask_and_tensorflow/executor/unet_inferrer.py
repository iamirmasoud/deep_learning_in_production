...
class UnetInferrer:
    def __init__(self):
        ...
        self.saved_path = "/media/masoud/F60C689F0C685C9D/GIT_REPOS/ML_OPS/deep_learning_in_production/8_deploy_a_deep_learning_model_as_a_web_application_using_flask_and_tensorflow/saved_models/unet/1"
