...
class UnetInferrer:
    def __init__(self):
        ...
        self.saved_path = "/media/masoud/F60C689F0C685C9D/GIT_REPOS/ML_OPS/deep_learning_in_production/9_how_to_use_uwsgi_and_nginx_to_serve_a_deep_learning_model/saved_models/unet/1"
